  ...
  weeks: [
    {
      ...
      grammar: {
        ...
        examples: [
          { en: "I have lived here for five years.", th: "ฉันอาศัยอยู่ที่นี่มาห้าปีแล้ว", highlight: "have lived" },
          { en: "She has never been to Japan.", th: "เธอไม่เคยไปญี่ปุ่นเลย", highlight: "has never been" },
          { en: "They have already finished the report.", th: "พวกเขาทำรายงานเสร็จเรียบร้อยแล้ว", highlight: "have already finished" },
          { en: "Have you ever tried Thai food?", th: "คุณเคยลองกินอาหารไทยไหม", highlight: "Have you ever tried" }
        ]
      },
      vocabulary: [
        { en: "achievement", th: "ความสำเร็จ", example: "Getting this job is a big achievement for me.", exampleTh: "การได้งานนี้ถือเป็นความสำเร็จที่ยิ่งใหญ่สำหรับฉัน" },
        { en: "personality", th: "บุคลิกภาพ", example: "Her outgoing personality makes her easy to talk to.", exampleTh: "บุคลิกภาพที่ร่าเริงเปิดเผยของเธอทำให้คุยด้วยง่าย" },
        { en: "background", th: "ภูมิหลัง / ประวัติความเป็นมา", example: "He comes from a business background.", exampleTh: "เขามีภูมิหลังมาจากครอบครัวที่ทำธุรกิจ" },
        { en: "hobby", th: "งานอดิเรก", example: "Reading novels is my favorite hobby.", exampleTh: "การอ่านนิยายเป็นงานอดิเรกที่ฉันชอบที่สุด" },
        { en: "accomplish", th: "ทำสำเร็จ / บรรลุผล", example: "I accomplished all my goals this year.", exampleTh: "ฉันทำเป้าหมายทั้งหมดของฉันสำเร็จในปีนี้" },
        { en: "curious", th: "อยากรู้อยากเห็น", example: "She has always been curious about other cultures.", exampleTh: "เธออยากรู้อยากเห็นเกี่ยวกับวัฒนธรรมอื่นๆ มาโดยตลอด" },
        { en: "ambitious", th: "ทะเยอทะยาน / มีความมุ่งมั่น", example: "He is ambitious and wants to start his own company.", exampleTh: "เขาเป็นคนทะเยอทะยานและอยากเริ่มบริษัทของตัวเอง" },
        { en: "experience", th: "ประสบการณ์", example: "I have gained a lot of experience from this job.", exampleTh: "ฉันได้รับประสบการณ์มากมายจากงานนี้" },
        { en: "journey", th: "การเดินทาง / เส้นทางชีวิต", example: "Learning English has been a long journey for me.", exampleTh: "การเรียนภาษาอังกฤษเป็นการเดินทางที่ยาวนานสำหรับฉัน" },
        { en: "milestone", th: "จุดสำคัญ / ก้าวสำคัญ", example: "Graduating from university was a major milestone in her life.", exampleTh: "การเรียนจบมหาวิทยาลัยเป็นก้าวสำคัญในชีวิตของเธอ" }
      ],
      reading: {
      ...
      story: {
        ...
        sentences: [
          { en: "In a small town, there was a cat named Milo who had always been curious about everything.", th: "ในเมืองเล็กๆ แห่งหนึ่ง มีแมวตัวหนึ่งชื่อไมโล ที่อยากรู้อยากเห็นไปเสียทุกอย่างมาโดยตลอด" },
          { en: "Milo has never been an ordinary cat.", th: "ไมโลไม่เคยเป็นแมวธรรมดาเลยสักครั้ง" },
          { en: "One day, he decided to explore the world outside his garden.", th: "วันหนึ่ง เขาตัดสินใจออกไปสำรวจโลกภายนอกสวนของตัวเอง" },
          { en: "During his journey, he has visited five different neighborhoods.", th: "ระหว่างการเดินทาง เขาได้ไปเยือนย่านต่างๆ ถึงห้าแห่ง" },
          { en: "He has met many new friends, including a wise old dog and a talkative parrot.", th: "เขาได้พบเพื่อนใหม่มากมาย รวมถึงสุนัขแก่ผู้ชาญฉลาดและนกแก้วที่ช่างพูด" },
          { en: "The parrot told him stories about places Milo had never even imagined.", th: "นกแก้วเล่าเรื่องราวเกี่ยวกับสถานที่ที่ไมโลไม่เคยจินตนาการถึงมาก่อนให้เขาฟัง" },
          { en: "By the end of the week, Milo had already learned so much about the world.", th: "เมื่อถึงสิ้นสัปดาห์ ไมโลได้เรียนรู้เกี่ยวกับโลกไปมากมายแล้ว" },
          { en: "His biggest achievement was finding his way back home safely.", th: "ความสำเร็จที่ยิ่งใหญ่ที่สุดของเขาคือการหาทางกลับบ้านได้อย่างปลอดภัย" },
          { en: "When he arrived, his family was surprised by how much he had changed.", th: "เมื่อเขากลับถึงบ้าน ครอบครัวของเขาต่างประหลาดใจที่เขาเปลี่ยนไปมากเพียงใด" },
          { en: "Milo smiled and said that his curiosity had given him the best adventure of his life.", th: "ไมโลยิ้มและบอกว่าความอยากรู้อยากเห็นของเขาได้มอบการผจญภัยที่ดีที่สุดในชีวิตให้กับเขา" }
        ]
      },
      quiz: [
    ...
    },
    {
      ...
      grammar: {
        ...
        examples: [
          { en: "I used to live in a small village.", th: "ฉันเคยอาศัยอยู่ในหมู่บ้านเล็กๆ", highlight: "used to live" },
          { en: "She didn't use to like coffee, but now she loves it.", th: "เธอเคยไม่ชอบกาแฟ แต่ตอนนี้เธอชอบมันมาก", highlight: "didn't use to like" },
          { en: "I was watching TV when my friend called.", th: "ฉันกำลังดูทีวีอยู่ตอนที่เพื่อนโทรมา", highlight: "was watching" },
          { en: "While we were walking home, it started to rain.", th: "ขณะที่เรากำลังเดินกลับบ้าน ฝนก็เริ่มตก", highlight: "were walking" }
        ]
      },
      vocabulary: [
        { en: "childhood", th: "วัยเด็ก", example: "I had a happy childhood in the countryside.", exampleTh: "ฉันมีวัยเด็กที่มีความสุขในชนบท" },
        { en: "habit", th: "นิสัย / พฤติกรรมที่ทำเป็นประจำ", example: "Reading before bed is a good habit.", exampleTh: "การอ่านหนังสือก่อนนอนเป็นนิสัยที่ดี" },
        { en: "memory", th: "ความทรงจำ", example: "I have fond memories of my grandmother's house.", exampleTh: "ฉันมีความทรงจำที่ดีเกี่ยวกับบ้านของคุณยาย" },
        { en: "nostalgic", th: "คิดถึงอดีต / รู้สึกอาลัยอาวรณ์", example: "This song makes me feel nostalgic about my school days.", exampleTh: "เพลงนี้ทำให้ฉันรู้สึกคิดถึงช่วงเวลาที่เรียนหนังสือ" },
        { en: "routine", th: "กิจวัตรประจำวัน", example: "My morning routine used to be very different.", exampleTh: "กิจวัตรตอนเช้าของฉันเคยแตกต่างไปจากนี้มาก" },
        { en: "upbringing", th: "การเลี้ยงดู", example: "His strict upbringing taught him discipline.", exampleTh: "การเลี้ยงดูที่เข้มงวดสอนให้เขามีวินัย" },
        { en: "tradition", th: "ประเพณี", example: "We used to follow this tradition every New Year.", exampleTh: "เราเคยปฏิบัติตามประเพณีนี้ทุกปีใหม่" },
        { en: "generation", th: "รุ่น / เจเนอเรชัน", example: "My generation grew up without smartphones.", exampleTh: "คนรุ่นของฉันเติบโตมาโดยไม่มีสมาร์ทโฟน" },
        { en: "reminisce", th: "รำลึกความหลัง", example: "We sat reminiscing about our university days.", exampleTh: "เรานั่งรำลึกความหลังถึงช่วงเวลาที่เรียนมหาวิทยาลัย" },
        { en: "transform", th: "เปลี่ยนแปลงอย่างมาก", example: "The neighborhood has completely transformed since I was a child.", exampleTh: "ย่านนี้เปลี่ยนแปลงไปโดยสิ้นเชิงตั้งแต่ตอนที่ฉันยังเป็นเด็ก" }
      ],
      reading: {
      ...
      story: {
        ...
        sentences: [
          { en: "When Mali was young, she used to bury small treasures under the old mango tree in her yard.", th: "ตอนที่มาลียังเด็ก เธอเคยฝังของล้ำค่าชิ้นเล็กๆ ไว้ใต้ต้นมะม่วงเก่าในสวนของเธอ" },
          { en: "She used to believe that the tree kept her secrets safe forever.", th: "เธอเคยเชื่อว่าต้นไม้ต้นนั้นจะเก็บความลับของเธอไว้อย่างปลอดภัยตลอดไป" },
          { en: "One rainy afternoon, while she was cleaning the old shed, she found a rusty tin box.", th: "บ่ายวันฝนตกวันหนึ่ง ขณะที่เธอกำลังทำความสะอาดโรงเก็บของเก่า เธอพบกล่องดีบุกที่เป็นสนิม" },
          { en: "As she opened it, a wave of childhood memories came flooding back.", th: "เมื่อเธอเปิดกล่องออก ความทรงจำในวัยเด็กก็หลั่งไหลกลับมาอย่างท่วมท้น" },
          { en: "Inside, she found a small toy car, a faded photograph, and a letter she had never sent.", th: "ภายในกล่อง เธอพบรถของเล่นเล็กๆ ภาพถ่ายที่จางไปตามกาลเวลา และจดหมายที่เธอไม่เคยส่งออกไป" },
          { en: "While she was reading the letter, it started to rain heavily outside.", th: "ขณะที่เธอกำลังอ่านจดหมายอยู่ ฝนก็เริ่มตกลงมาอย่างหนักข้างนอก" },
          { en: "The letter was addressed to her best friend, who used to live next door many years ago.", th: "จดหมายฉบับนั้นเขียนถึงเพื่อนสนิทของเธอ ผู้ที่เคยอาศัยอยู่บ้านข้างๆ เมื่อหลายปีก่อน" },
          { en: "Mali felt nostalgic and decided to finally send the letter after all this time.", th: "มาลีรู้สึกคิดถึงอดีตและตัดสินใจส่งจดหมายฉบับนั้นในที่สุด หลังจากผ่านมานานขนาดนี้" },
          { en: "A week later, her old friend replied with a warm message and a photo of her own mango tree.", th: "หนึ่งสัปดาห์ต่อมา เพื่อนเก่าของเธอตอบกลับมาด้วยข้อความอบอุ่นพร้อมภาพถ่ายต้นมะม่วงของเธอเอง" },
          { en: "Some memories, Mali realized, are worth digging up again.", th: "มาลีตระหนักว่าความทรงจำบางอย่างก็คุ้มค่าที่จะขุดคุ้ยขึ้นมาอีกครั้ง" }
        ]
      },
      quiz: [
    ...
    },
    {
      ...
      grammar: {
        ...
        examples: [
          { en: "I think it will rain later today.", th: "ฉันคิดว่าฝนจะตกในช่วงหลังของวันนี้", highlight: "will rain" },
          { en: "We are going to launch the new product next month.", th: "เราจะเปิดตัวสินค้าใหม่ในเดือนหน้า", highlight: "are going to launch" },
          { en: "I'm meeting my client at 5 PM tomorrow.", th: "ฉันมีนัดพบลูกค้าตอนห้าโมงเย็นพรุ่งนี้", highlight: "I'm meeting" },
          { en: "She's going to study abroad next year.", th: "เธอจะไปเรียนต่อต่างประเทศปีหน้า", highlight: "going to study" }
        ]
      },
      vocabulary: [
        { en: "intend", th: "ตั้งใจ / มีความประสงค์", example: "I intend to finish this project by Friday.", exampleTh: "ฉันตั้งใจจะทำโปรเจกต์นี้ให้เสร็จภายในวันศุกร์" },
        { en: "forecast", th: "พยากรณ์ / คาดการณ์", example: "The weather forecast predicts heavy rain tomorrow.", exampleTh: "พยากรณ์อากาศคาดว่าพรุ่งนี้จะมีฝนตกหนัก" },
        { en: "resolution", th: "ความตั้งใจ / ปณิธาน", example: "My New Year's resolution is to exercise more.", exampleTh: "ปณิธานปีใหม่ของฉันคือการออกกำลังกายให้มากขึ้น" },
        { en: "anticipate", th: "คาดการณ์ล่วงหน้า", example: "We anticipate strong demand for this product.", exampleTh: "เราคาดการณ์ว่าสินค้านี้จะมีความต้องการสูง" },
        { en: "upcoming", th: "ที่กำลังจะมาถึง", example: "Are you ready for the upcoming exam?", exampleTh: "คุณพร้อมสำหรับการสอบที่กำลังจะมาถึงหรือยัง" },
        { en: "arrangement", th: "การนัดหมาย / การจัดเตรียม", example: "I've made arrangements to meet him at the airport.", exampleTh: "ฉันได้จัดเตรียมนัดหมายเพื่อไปพบเขาที่สนามบิน" },
        { en: "prospect", th: "แนวโน้ม / ความเป็นไปได้", example: "The prospect of a promotion excites her.", exampleTh: "แนวโน้มที่จะได้เลื่อนตำแหน่งทำให้เธอรู้สึกตื่นเต้น" },
        { en: "likely", th: "มีแนวโน้ม / น่าจะเป็นไปได้", example: "It's likely to rain this afternoon.", exampleTh: "มีแนวโน้มว่าฝนจะตกในช่วงบ่ายนี้" },
        { en: "tendency", th: "แนวโน้ม / นิสัยที่มักจะทำ", example: "He has a tendency to arrive late.", exampleTh: "เขามีแนวโน้มที่จะมาสาย" },
        { en: "aim", th: "เป้าหมาย / มุ่งหมาย", example: "Our aim is to expand into new markets.", exampleTh: "เป้าหมายของเราคือการขยายไปสู่ตลาดใหม่" }
      ],
      reading: {
      ...
      story: {
        ...
        sentences: [
          { en: "Every morning, a young duck named Boonmee watched the older ducks fly south for the winter.", th: "ทุกเช้า เป็ดหนุ่มตัวหนึ่งชื่อบุญมีเฝ้ามองเป็ดตัวโตบินไปทางใต้ในฤดูหนาว" },
          { en: "This year, Boonmee has decided that he is going to join them for the very first time.", th: "ปีนี้ บุญมีตัดสินใจแล้วว่าเขาจะไปร่วมบินกับพวกมันเป็นครั้งแรก" },
          { en: "He is going to practice flying every single day until he is strong enough.", th: "เขาจะฝึกบินทุกวันจนกว่าจะแข็งแรงพอ" },
          { en: "\"I intend to reach the warm lake before the first snow falls,\" he told his friends proudly.", th: "\"ฉันตั้งใจจะไปให้ถึงทะเลสาบที่อบอุ่นก่อนที่หิมะแรกจะตก\" เขาพูดกับเพื่อนๆ อย่างภาคภูมิใจ" },
          { en: "The forecast predicted strong winds, but Boonmee was not afraid of the challenge ahead.", th: "พยากรณ์อากาศคาดว่าจะมีลมแรง แต่บุญมีไม่กลัวความท้าทายที่รออยู่ข้างหน้า" },
          { en: "On the morning of the journey, he is meeting the whole flock at sunrise by the old oak tree.", th: "ในเช้าวันเดินทาง เขานัดพบกับฝูงเป็ดทั้งหมดตอนพระอาทิตย์ขึ้นที่ต้นโอ๊กเก่า" },
          { en: "Halfway through the trip, his wings grew tired, and he almost gave up.", th: "กลางทางการเดินทาง ปีกของเขาเริ่มล้า และเขาเกือบจะยอมแพ้" },
          { en: "But an older duck told him, \"Don't worry, we will rest together on that island.\"", th: "แต่เป็ดตัวโตกว่าบอกเขาว่า \"ไม่ต้องห่วง เราจะพักด้วยกันที่เกาะนั้น\"" },
          { en: "With new energy, Boonmee flapped his wings and finally reached the warm lake with the others.", th: "ด้วยพลังใหม่ บุญมีกระพือปีกจนในที่สุดก็ไปถึงทะเลสาบที่อบอุ่นพร้อมกับเพื่อนๆ" },
          { en: "That night, he realized that big dreams always feel impossible until the moment you achieve them.", th: "คืนนั้น เขาตระหนักว่าความฝันที่ยิ่งใหญ่มักดูเป็นไปไม่ได้เสมอ จนกว่าเราจะไปถึงมันสำเร็จ" }
        ]
      },
      quiz: [
    ...
    },
    {
      ...
      grammar: {
        ...
        examples: [
          { en: "I have worked at this company for three years.", th: "ฉันทำงานที่บริษัทนี้มาสามปีแล้ว", highlight: "have worked" },
          { en: "I worked at a bank before I joined this company in 2018.", th: "ฉันเคยทำงานที่ธนาคารก่อนที่จะเข้ามาทำงานที่บริษัทนี้ในปี 2018", highlight: "worked at a bank" },
          { en: "She has just received a promotion.", th: "เธอเพิ่งได้รับการเลื่อนตำแหน่ง", highlight: "has just received" },
          { en: "He resigned from his job last month.", th: "เขาลาออกจากงานเมื่อเดือนที่แล้ว", highlight: "resigned from his job" }
        ]
      },
      vocabulary: [
        { en: "promotion", th: "การเลื่อนตำแหน่ง", example: "She received a promotion after two years of hard work.", exampleTh: "เธอได้รับการเลื่อนตำแหน่งหลังจากทำงานหนักมาสองปี" },
        { en: "colleague", th: "เพื่อนร่วมงาน", example: "My colleague helped me finish the report on time.", exampleTh: "เพื่อนร่วมงานของฉันช่วยให้ฉันทำรายงานเสร็จทันเวลา" },
        { en: "resign", th: "ลาออก", example: "He decided to resign from his position last week.", exampleTh: "เขาตัดสินใจลาออกจากตำแหน่งเมื่อสัปดาห์ที่แล้ว" },
        { en: "qualification", th: "คุณสมบัติ / วุฒิการศึกษา", example: "This job requires a strong qualification in finance.", exampleTh: "งานนี้ต้องการคุณสมบัติที่แข็งแกร่งด้านการเงิน" },
        { en: "workload", th: "ปริมาณงาน", example: "My workload has increased a lot this year.", exampleTh: "ปริมาณงานของฉันเพิ่มขึ้นมากในปีนี้" },
        { en: "deadline", th: "กำหนดส่ง / เส้นตาย", example: "We have to meet the deadline by Friday.", exampleTh: "เราต้องทำงานให้เสร็จตามกำหนดส่งภายในวันศุกร์" },
        { en: "negotiate", th: "เจรจาต่อรอง", example: "I negotiated a higher salary during the interview.", exampleTh: "ฉันเจรจาต่อรองขอเงินเดือนที่สูงขึ้นระหว่างการสัมภาษณ์" },
        { en: "salary", th: "เงินเดือน", example: "The salary for this position is quite competitive.", exampleTh: "เงินเดือนสำหรับตำแหน่งนี้ค่อนข้างสูงเมื่อเทียบกับตลาด" },
        { en: "internship", th: "การฝึกงาน", example: "She did an internship at a marketing firm last summer.", exampleTh: "เธอฝึกงานที่บริษัทการตลาดเมื่อฤดูร้อนที่แล้ว" },
        { en: "resume", th: "ประวัติย่อสมัครงาน", example: "You should update your resume before applying for the job.", exampleTh: "คุณควรปรับปรุงประวัติย่อก่อนสมัครงาน" }
      ],
      reading: {
      ...
      story: {
        ...
        sentences: [
          { en: "Note has worked as a waiter at a small coffee shop for two years.", th: "โน้ตทำงานเป็นพนักงานเสิร์ฟที่ร้านกาแฟเล็กๆ มาสองปีแล้ว" },
          { en: "Every night after his shift, he practiced playing the guitar in his tiny apartment.", th: "ทุกคืนหลังเลิกงาน เขาฝึกเล่นกีตาร์ในอพาร์ตเมนต์เล็กๆ ของเขา" },
          { en: "One evening, a famous musician walked into the coffee shop by chance.", th: "เย็นวันหนึ่ง นักดนตรีชื่อดังคนหนึ่งเดินเข้ามาที่ร้านกาแฟโดยบังเอิญ" },
          { en: "While Note was serving coffee, he accidentally hummed one of his own songs.", th: "ขณะที่โน้ตกำลังเสิร์ฟกาแฟ เขาเผลอฮัมเพลงที่ตัวเองแต่งขึ้นมาโดยไม่รู้ตัว" },
          { en: "The musician has never heard such an interesting melody from a stranger before.", th: "นักดนตรีคนนั้นไม่เคยได้ยินทำนองที่น่าสนใจแบบนี้จากคนแปลกหน้ามาก่อนเลย" },
          { en: "He asked Note to play the full song after his shift ended.", th: "เขาขอให้โน้ตเล่นเพลงเต็มเพลงให้ฟังหลังเลิกงาน" },
          { en: "Note nervously picked up his old guitar and played the melody he had written last year.", th: "โน้ตหยิบกีตาร์เก่าของเขาขึ้นมาด้วยความประหม่าและเล่นทำนองที่เขาแต่งไว้เมื่อปีที่แล้ว" },
          { en: "The musician was amazed and immediately offered him a chance to record a demo.", th: "นักดนตรีคนนั้นรู้สึกทึ่งและเสนอโอกาสให้เขาอัดเดโมทันที" },
          { en: "Last month, Note resigned from his job at the coffee shop to focus on music full-time.", th: "เดือนที่แล้ว โน้ตลาออกจากงานที่ร้านกาแฟเพื่อมาทำเพลงอย่างเต็มตัว" },
          { en: "He says he has never regretted following his dream, even though the journey has just begun.", th: "เขาบอกว่าเขาไม่เคยเสียใจเลยที่ได้ทำตามความฝันของตัวเอง แม้ว่าการเดินทางเพิ่งจะเริ่มต้นก็ตาม" }
        ]
      },
      quiz: [
    ...
    },
    {
      ...
      grammar: {
        ...
        examples: [
          { en: "The woman who lives next door is a doctor.", th: "ผู้หญิงที่อาศัยอยู่บ้านข้างๆ เป็นหมอ", highlight: "who lives next door" },
          { en: "This is the café which serves the best coffee in town.", th: "นี่คือร้านกาแฟที่เสิร์ฟกาแฟที่ดีที่สุดในเมือง", highlight: "which serves the best coffee in town" },
          { en: "I met a man that used to work with my father.", th: "ฉันเจอผู้ชายคนหนึ่งที่เคยทำงานกับพ่อของฉัน", highlight: "that used to work with my father" },
          { en: "This is the village where I grew up.", th: "นี่คือหมู่บ้านที่ฉันเติบโตขึ้นมา", highlight: "where I grew up" }
        ]
      },
      vocabulary: [
        { en: "characteristic", th: "ลักษณะเฉพาะ", example: "Kindness is one of her best characteristics.", exampleTh: "ความใจดีเป็นหนึ่งในลักษณะเฉพาะที่ดีที่สุดของเธอ" },
        { en: "landmark", th: "สถานที่สำคัญ / จุดสังเกต", example: "The old temple is a famous landmark in this city.", exampleTh: "วัดเก่าแห่งนี้เป็นสถานที่สำคัญที่มีชื่อเสียงของเมืองนี้" },
        { en: "atmosphere", th: "บรรยากาศ", example: "The café has a cozy atmosphere.", exampleTh: "ร้านกาแฟแห่งนี้มีบรรยากาศอบอุ่นสบาย" },
        { en: "resident", th: "ผู้อยู่อาศัย", example: "Local residents enjoy walking in this park every morning.", exampleTh: "ผู้อยู่อาศัยในท้องถิ่นชอบเดินเล่นในสวนแห่งนี้ทุกเช้า" },
        { en: "scenery", th: "ทัศนียภาพ / ทิวทัศน์", example: "The scenery along the coast is breathtaking.", exampleTh: "ทัศนียภาพตามแนวชายฝั่งสวยงามจนน่าทึ่ง" },
        { en: "community", th: "ชุมชน", example: "This community is known for being friendly and welcoming.", exampleTh: "ชุมชนแห่งนี้เป็นที่รู้จักในเรื่องความเป็นมิตรและการต้อนรับที่ดี" },
        { en: "diverse", th: "หลากหลาย", example: "The city has a diverse population from many countries.", exampleTh: "เมืองนี้มีประชากรที่หลากหลายมาจากหลายประเทศ" },
        { en: "vibrant", th: "มีชีวิตชีวา / คึกคัก", example: "The night market has a vibrant atmosphere.", exampleTh: "ตลาดกลางคืนมีบรรยากาศที่มีชีวิตชีวา" },
        { en: "remote", th: "ห่างไกล", example: "They live in a remote village in the mountains.", exampleTh: "พวกเขาอาศัยอยู่ในหมู่บ้านห่างไกลบนภูเขา" },
        { en: "picturesque", th: "สวยงามราวภาพวาด", example: "The picturesque village attracts many tourists.", exampleTh: "หมู่บ้านที่สวยงามราวภาพวาดแห่งนี้ดึงดูดนักท่องเที่ยวจำนวนมาก" }
      ],
      reading: {
      ...
      story: {
        ...
        sentences: [
          { en: "There is an old lighthouse on the coast that has guided sailors for over a hundred years.", th: "มีประภาคารเก่าแก่แห่งหนึ่งบนชายฝั่งที่นำทางให้ชาวเรือมานานกว่าร้อยปี" },
          { en: "The man who takes care of it is named Grandpa Suk, and everyone in the village respects him.", th: "ชายผู้ดูแลประภาคารแห่งนี้ชื่อปู่สุข และทุกคนในหมู่บ้านต่างเคารพเขา" },
          { en: "The village where Grandpa Suk lives is small, quiet, and surrounded by picturesque cliffs.", th: "หมู่บ้านที่ปู่สุขอาศัยอยู่นั้นเล็ก เงียบสงบ และล้อมรอบไปด้วยหน้าผาที่สวยงามราวภาพวาด" },
          { en: "One stormy night, a fishing boat that was heading home lost its way in the dark waves.", th: "คืนหนึ่งที่พายุแรง เรือประมงลำหนึ่งที่กำลังมุ่งหน้ากลับบ้านหลงทางในคลื่นมืดมิด" },
          { en: "Grandpa Suk, who had never left his post during a storm, climbed the tower to light the lamp.", th: "ปู่สุขผู้ไม่เคยทิ้งหน้าที่ในยามพายุ ปีนขึ้นไปบนหอคอยเพื่อจุดไฟส่องสว่าง" },
          { en: "The light which shone through the darkness guided the boat safely back to the harbor.", th: "แสงไฟที่ส่องผ่านความมืดนำทางให้เรือกลับเข้าฝั่งอย่างปลอดภัย" },
          { en: "The fishermen, whose families were waiting anxiously, thanked him with tears of relief.", th: "ชาวประมงซึ่งครอบครัวกำลังรอคอยด้วยความกังวลใจ ต่างขอบคุณเขาด้วยน้ำตาแห่งความโล่งใจ" },
          { en: "News of the rescue spread quickly through the community, which had always admired the old lighthouse keeper.", th: "ข่าวการช่วยเหลือแพร่กระจายไปทั่วชุมชนอย่างรวดเร็ว ซึ่งชื่นชมผู้ดูแลประภาคารคนนี้อยู่แล้วเสมอมา" },
          { en: "Today, tourists who visit the lighthouse always ask to hear the story of that unforgettable night.", th: "ทุกวันนี้ นักท่องเที่ยวที่มาเยือนประภาคารมักขอฟังเรื่องราวของคืนอันน่าจดจำนั้นเสมอ" },
          { en: "Grandpa Suk simply smiles and says the sea, which he has watched his whole life, still has many secrets left.", th: "ปู่สุขเพียงแค่ยิ้มและบอกว่าทะเลซึ่งเขาเฝ้ามองมาตลอดชีวิต ยังคงมีความลับอีกมากมายที่ซ่อนอยู่" }
        ]
      },
      quiz: [
    ...
    },
    {
      ...
      grammar: {
        ...
        examples: [
          { en: "I would say that social media has more disadvantages than advantages.", th: "ฉันคิดว่าโซเชียลมีเดียมีข้อเสียมากกว่าข้อดี", highlight: "I would say" },
          { en: "It could be argued that working from home increases productivity.", th: "อาจกล่าวได้ว่าการทำงานจากบ้านช่วยเพิ่มประสิทธิภาพการทำงาน", highlight: "It could be argued" },
          { en: "I don't really enjoy spicy food. – Neither do I.", th: "ฉันไม่ค่อยชอบกินอาหารเผ็ดเท่าไหร่ - ฉันก็เหมือนกัน", highlight: "Neither do I" },
          { en: "I think this policy is a good idea. – So do I.", th: "ฉันคิดว่านโยบายนี้เป็นความคิดที่ดี - ฉันก็คิดแบบนั้นเหมือนกัน", highlight: "So do I" }
        ]
      },
      vocabulary: [
        { en: "perspective", th: "มุมมอง", example: "From my perspective, this decision was necessary.", exampleTh: "จากมุมมองของฉัน การตัดสินใจครั้งนี้มีความจำเป็น" },
        { en: "controversial", th: "เป็นที่ถกเถียง", example: "Climate change policy is a controversial topic.", exampleTh: "นโยบายด้านการเปลี่ยนแปลงสภาพภูมิอากาศเป็นหัวข้อที่เป็นที่ถกเถียง" },
        { en: "convince", th: "ทำให้เชื่อ / โน้มน้าว", example: "He tried to convince me to change my mind.", exampleTh: "เขาพยายามโน้มน้าวให้ฉันเปลี่ยนใจ" },
        { en: "argument", th: "ข้อโต้แย้ง / เหตุผล", example: "She made a strong argument in favor of the new law.", exampleTh: "เธอนำเสนอข้อโต้แย้งที่หนักแน่นสนับสนุนกฎหมายใหม่" },
        { en: "standpoint", th: "จุดยืน", example: "From an economic standpoint, the plan makes sense.", exampleTh: "จากจุดยืนทางเศรษฐกิจ แผนนี้ดูสมเหตุสมผล" },
        { en: "skeptical", th: "ไม่เชื่อ / สงสัย", example: "I'm skeptical about whether this plan will actually work.", exampleTh: "ฉันไม่ค่อยเชื่อว่าแผนนี้จะได้ผลจริงหรือไม่" },
        { en: "biased", th: "มีอคติ / ลำเอียง", example: "The report seemed biased toward one political party.", exampleTh: "รายงานดูเหมือนจะมีอคติเอนเอียงไปทางพรรคการเมืองหนึ่ง" },
        { en: "valid", th: "สมเหตุสมผล / ใช้ได้", example: "That's a valid point, but I still disagree.", exampleTh: "นั่นเป็นประเด็นที่สมเหตุสมผล แต่ฉันก็ยังไม่เห็นด้วยอยู่ดี" },
        { en: "compromise", th: "การประนีประนอม", example: "We reached a compromise after a long discussion.", exampleTh: "เราบรรลุข้อตกลงประนีประนอมกันหลังจากพูดคุยกันอย่างยาวนาน" },
        { en: "assert", th: "ยืนยัน / กล่าวอย่างมั่นใจ", example: "She asserted that the new policy would help small businesses.", exampleTh: "เธอยืนยันอย่างมั่นใจว่านโยบายใหม่จะช่วยธุรกิจขนาดเล็ก" }
      ],
      reading: {
      ...
      story: {
        ...
        sentences: [
          { en: "Every weekend, Ploy and her roommate Tum have the same argument about durian.", th: "ทุกสุดสัปดาห์ พลอยกับทัม เพื่อนร่วมห้อง มักจะทะเลาะกันเรื่องเดิมๆ เกี่ยวกับทุเรียน" },
          { en: "Ploy insists that durian is the most delicious fruit in the world, but Tum finds the smell unbearable.", th: "พลอยยืนยันว่าทุเรียนเป็นผลไม้ที่อร่อยที่สุดในโลก แต่ทัมรู้สึกว่ากลิ่นของมันทนไม่ไหว" },
          { en: "\"I would say you're exaggerating how bad it smells,\" Ploy told her one evening.", th: "\"ฉันว่าเธอพูดเกินจริงไปว่ากลิ่นมันแย่ขนาดนั้น\" พลอยพูดกับเธอในเย็นวันหนึ่ง" },
          { en: "Tum replied that from her standpoint, the smell was simply too strong to ignore.", th: "ทัมตอบว่าจากจุดยืนของเธอ กลิ่นนั้นแรงเกินกว่าจะเพิกเฉยได้" },
          { en: "It could be argued that both of them had valid points about taste and tolerance.", th: "อาจกล่าวได้ว่าทั้งสองคนต่างก็มีประเด็นที่สมเหตุสมผลเกี่ยวกับรสนิยมและความอดทน" },
          { en: "One day, their neighbor overheard the argument and offered a compromise.", th: "วันหนึ่ง เพื่อนบ้านของพวกเขาได้ยินการถกเถียงและเสนอทางประนีประนอม" },
          { en: "\"Why don't you eat durian on the balcony instead of the kitchen?\" she suggested.", th: "\"ทำไมไม่กินทุเรียนที่ระเบียงแทนที่จะกินในครัวล่ะ\" เธอแนะนำ" },
          { en: "Ploy admitted it was a valid idea, even though she was skeptical at first.", th: "พลอยยอมรับว่านั่นเป็นความคิดที่สมเหตุสมผล แม้ว่าตอนแรกเธอจะไม่ค่อยเชื่อก็ตาม" },
          { en: "\"I don't want to keep arguing about this every week.\" – \"Neither do I,\" Tum agreed with a laugh.", th: "\"ฉันไม่อยากทะเลาะเรื่องนี้ทุกสัปดาห์แล้ว\" - \"ฉันก็เหมือนกัน\" ทัมเห็นด้วยพร้อมกับหัวเราะ" },
          { en: "From that day on, durian season became a lot more peaceful in their apartment.", th: "ตั้งแต่วันนั้นเป็นต้นมา ฤดูทุเรียนก็สงบสุขมากขึ้นในอพาร์ตเมนต์ของพวกเขา" }
        ]
      },
      quiz: [
    ...
    },
    {
      ...
      grammar: {
        ...
        examples: [
          { en: "If it rains tomorrow, I will cancel the picnic.", th: "ถ้าพรุ่งนี้ฝนตก ฉันจะยกเลิกปิกนิก", highlight: "will cancel" },
          { en: "If I had more free time, I would learn to play the guitar.", th: "ถ้าฉันมีเวลาว่างมากกว่านี้ ฉันจะเรียนเล่นกีตาร์", highlight: "would learn" },
          { en: "If she studies hard, she will pass the exam.", th: "ถ้าเธอตั้งใจเรียน เธอจะสอบผ่าน", highlight: "will pass" },
          { en: "If I were you, I would accept the job offer.", th: "ถ้าฉันเป็นคุณ ฉันจะรับข้อเสนองานนั้น", highlight: "would accept" }
        ]
      },
      vocabulary: [
        { en: "hypothetical", th: "สมมติ", example: "Let's consider a hypothetical situation for a moment.", exampleTh: "ลองพิจารณาสถานการณ์สมมติสักครู่หนึ่ง" },
        { en: "scenario", th: "สถานการณ์สมมติ", example: "In this scenario, what would you do?", exampleTh: "ในสถานการณ์สมมตินี้ คุณจะทำอย่างไร" },
        { en: "consequence", th: "ผลที่ตามมา", example: "Every decision has consequences.", exampleTh: "การตัดสินใจทุกอย่างย่อมมีผลที่ตามมา" },
        { en: "alternative", th: "ทางเลือกอื่น", example: "If this plan fails, we need an alternative.", exampleTh: "ถ้าแผนนี้ล้มเหลว เราต้องมีทางเลือกอื่น" },
        { en: "dilemma", th: "สถานการณ์กลืนไม่เข้าคายไม่ออก", example: "She faced a difficult dilemma about which job to choose.", exampleTh: "เธอเผชิญกับสถานการณ์ที่ยากลำบากในการเลือกว่าจะทำงานไหนดี" },
        { en: "assume", th: "สันนิษฐาน / สมมติ", example: "Let's assume the meeting starts at 9 AM.", exampleTh: "สมมติว่าการประชุมเริ่มเวลาเก้าโมงเช้า" },
        { en: "suppose", th: "สมมติว่า / คาดว่า", example: "Suppose you lost your job tomorrow, what would you do?", exampleTh: "สมมติว่าคุณตกงานพรุ่งนี้ คุณจะทำอย่างไร" },
        { en: "circumstance", th: "สถานการณ์ / สภาพแวดล้อม", example: "Under these circumstances, I would make the same decision.", exampleTh: "ภายใต้สถานการณ์เช่นนี้ ฉันก็จะตัดสินใจแบบเดียวกัน" },
        { en: "outcome", th: "ผลลัพธ์", example: "We are still waiting for the outcome of the negotiation.", exampleTh: "เรายังคงรอผลลัพธ์ของการเจรจาอยู่" },
        { en: "regret", th: "เสียใจ / เสียดาย", example: "I would regret it if I didn't take this opportunity.", exampleTh: "ฉันคงจะเสียใจถ้าไม่คว้าโอกาสนี้ไว้" }
      ],
      reading: {
      ...
      story: {
        ...
        sentences: [
          { en: "Tam always wondered what he would do if he could relive just one day of his life.", th: "แทมมักสงสัยเสมอว่าเขาจะทำอะไรถ้าสามารถย้อนกลับไปใช้ชีวิตอีกครั้งในหนึ่งวัน" },
          { en: "One night, he found an old pocket watch in his grandfather's attic that seemed to glow strangely.", th: "คืนหนึ่ง เขาพบนาฬิกาพกเก่าในห้องใต้หลังคาของคุณปู่ ซึ่งดูเหมือนจะเปล่งแสงประหลาด" },
          { en: "A tiny note attached to it read, \"If you turn this back, you will return to any day you choose.\"", th: "มีโน้ตเล็กๆ ติดอยู่เขียนว่า \"ถ้าคุณหมุนมันย้อนกลับ คุณจะได้กลับไปยังวันใดก็ได้ที่คุณเลือก\"" },
          { en: "Tam decided to try it, thinking that if it were real, he would visit the day he missed his best friend's graduation.", th: "แทมตัดสินใจลองดู โดยคิดว่าถ้ามันเป็นเรื่องจริง เขาจะย้อนไปวันที่เขาพลาดงานรับปริญญาของเพื่อนสนิท" },
          { en: "Suddenly, he found himself standing outside the graduation hall, exactly as it had looked years ago.", th: "ทันใดนั้น เขาพบว่าตัวเองยืนอยู่หน้าหอประชุมรับปริญญา เหมือนกับที่มันเคยเป็นเมื่อหลายปีก่อนทุกประการ" },
          { en: "If he hurried, he would still be able to see his friend walk across the stage.", th: "ถ้าเขารีบเดินตอนนี้ เขาก็จะยังทันได้เห็นเพื่อนเดินขึ้นเวทีรับปริญญา" },
          { en: "He ran through the crowd, and just in time, he shouted his friend's name with pride.", th: "เขาวิ่งฝ่าฝูงชนไป และทันเวลาพอดี เขาตะโกนเรียกชื่อเพื่อนด้วยความภาคภูมิใจ" },
          { en: "His friend turned, smiled, and waved, not knowing that Tam had traveled through time just to be there.", th: "เพื่อนของเขาหันมา ยิ้ม และโบกมือให้ โดยไม่รู้เลยว่าแทมได้เดินทางข้ามเวลามาเพื่อให้ทันช่วงเวลานั้น" },
          { en: "When the watch glowed again, Tam knew that if he stayed any longer, he might never return.", th: "เมื่อนาฬิกาเปล่งแสงอีกครั้ง แทมรู้ว่าถ้าเขาอยู่ต่อไปอีก เขาอาจไม่มีวันได้กลับไปเลย" },
          { en: "Back in the present, he realized that if he hadn't missed that day the first time, he would never have understood how precious it truly was.", th: "เมื่อกลับมาสู่ปัจจุบัน เขาตระหนักว่าถ้าเขาไม่เคยพลาดวันนั้นไปตั้งแต่แรก เขาก็คงไม่มีวันเข้าใจว่าวันนั้นมีค่ามากเพียงใด" }
        ]
      },
      quiz: [
    ...
    },
    {
      ...
      grammar: {
        ...
        examples: [
          { en: "The news was reported by several major outlets.", th: "ข่าวนี้ถูกรายงานโดยสำนักข่าวใหญ่หลายแห่ง", highlight: "was reported" },
          { en: "This article was published yesterday.", th: "บทความนี้ถูกตีพิมพ์เมื่อวานนี้", highlight: "was published" },
          { en: "The event is being covered live by three TV stations.", th: "งานนี้กำลังถูกถ่ายทอดสดโดยสถานีโทรทัศน์สามช่อง", highlight: "is being covered" },
          { en: "Many facts in the story have been exaggerated.", th: "ข้อเท็จจริงหลายอย่างในเรื่องนี้ถูกพูดเกินจริง", highlight: "have been exaggerated" }
        ]
      },
      vocabulary: [
        { en: "headline", th: "พาดหัวข่าว", example: "The headline caught everyone's attention immediately.", exampleTh: "พาดหัวข่าวดึงดูดความสนใจของทุกคนได้ในทันที" },
        { en: "journalist", th: "นักข่าว", example: "The journalist interviewed several witnesses at the scene.", exampleTh: "นักข่าวสัมภาษณ์พยานหลายคนที่เกิดเหตุ" },
        { en: "broadcast", th: "การออกอากาศ / ถ่ายทอด", example: "The match was broadcast live on national television.", exampleTh: "การแข่งขันถูกถ่ายทอดสดทางโทรทัศน์ระดับประเทศ" },
        { en: "coverage", th: "การรายงานข่าว / การนำเสนอข่าว", example: "The election received extensive media coverage.", exampleTh: "การเลือกตั้งได้รับการนำเสนอข่าวอย่างครอบคลุมจากสื่อ" },
        { en: "publish", th: "เผยแพร่ / ตีพิมพ์", example: "The report was published in a major newspaper.", exampleTh: "รายงานฉบับนี้ถูกตีพิมพ์ในหนังสือพิมพ์ฉบับใหญ่" },
        { en: "censorship", th: "การเซ็นเซอร์ / การควบคุมสื่อ", example: "Some countries are known for strict media censorship.", exampleTh: "บางประเทศเป็นที่รู้จักในเรื่องการเซ็นเซอร์สื่ออย่างเข้มงวด" },
        { en: "source", th: "แหล่งข่าว / แหล่งที่มา", example: "The journalist refused to reveal her source.", exampleTh: "นักข่าวปฏิเสธที่จะเปิดเผยแหล่งข่าวของเธอ" },
        { en: "reliable", th: "น่าเชื่อถือ", example: "It's important to check whether a news source is reliable.", exampleTh: "สิ่งสำคัญคือต้องตรวจสอบว่าแหล่งข่าวนั้นน่าเชื่อถือหรือไม่" },
        { en: "exaggerate", th: "พูดเกินจริง", example: "The headline seemed to exaggerate the actual situation.", exampleTh: "พาดหัวข่าวดูเหมือนจะพูดเกินจริงไปจากสถานการณ์ที่แท้จริง" },
        { en: "outlet", th: "สำนักข่าว / ช่องทางเผยแพร่", example: "The story was picked up by several major news outlets.", exampleTh: "เรื่องราวนี้ถูกนำไปเผยแพร่โดยสำนักข่าวใหญ่หลายแห่ง" }
      ],
      reading: {
      ...
      story: {
        ...
        sentences: [
          { en: "Last spring, a strange pigeon with a small metal ring was spotted on the roof of a government building.", th: "ฤดูใบไม้ผลิที่แล้ว มีนกพิราบตัวหนึ่งที่มีห่วงโลหะเล็กๆ ถูกพบเห็นบนหลังคาของอาคารราชการ" },
          { en: "A local resident took a photo and posted it online, claiming the bird might be a spy drone.", th: "ชาวบ้านในพื้นที่คนหนึ่งถ่ายรูปไว้และโพสต์ลงออนไลน์ โดยอ้างว่านกตัวนี้อาจเป็นโดรนสายลับ" },
          { en: "The photo was shared thousands of times within a single day.", th: "รูปภาพนั้นถูกแชร์ต่อเป็นพันครั้งภายในวันเดียว" },
          { en: "Soon, the story was picked up by several news outlets, and the headline read, \"Mystery Spy Bird Spotted!\"", th: "ไม่นานนัก เรื่องนี้ก็ถูกนำไปเสนอโดยสำนักข่าวหลายแห่ง โดยพาดหัวข่าวเขียนว่า \"พบเห็นนกสายลับปริศนา!\"" },
          { en: "A journalist was sent to investigate, and the officials were interviewed about possible security threats.", th: "นักข่าวคนหนึ่งถูกส่งไปสืบสวน และเจ้าหน้าที่ก็ถูกสัมภาษณ์เกี่ยวกับภัยคุกคามด้านความปลอดภัยที่อาจเกิดขึ้น" },
          { en: "However, it was soon discovered that the ring was actually placed there by a local pigeon-racing club.", th: "อย่างไรก็ตาม ในเวลาต่อมาก็ค้นพบว่าห่วงนั้นถูกติดไว้โดยชมรมแข่งนกพิราบในท้องถิ่นต่างหาก" },
          { en: "The pigeon, named Number 27, had simply lost its way home during a race.", th: "นกพิราบตัวนั้นซึ่งมีชื่อว่าหมายเลข 27 เพียงแค่หลงทางกลับบ้านระหว่างการแข่งขัน" },
          { en: "A correction was published the next day, and the exaggerated claims were quickly withdrawn.", th: "คำแก้ไขข่าวถูกตีพิมพ์ในวันถัดมา และข้อกล่าวอ้างที่พูดเกินจริงก็ถูกถอนออกอย่างรวดเร็ว" },
          { en: "The story is now often mentioned as an example of how quickly rumors can be spread online.", th: "เรื่องนี้มักถูกยกมาเป็นตัวอย่างว่าข่าวลือสามารถแพร่กระจายทางออนไลน์ได้รวดเร็วเพียงใด" },
          { en: "As for Number 27, he was safely reunited with his owner and, according to reports, has never tried to \"spy\" on anyone since.", th: "ส่วนหมายเลข 27 นั้นได้กลับไปอยู่กับเจ้าของอย่างปลอดภัย และตามรายงานระบุว่าเขาไม่เคย \"เป็นสายลับ\" ให้ใครอีกเลยนับแต่นั้นมา" }
        ]
      },
      quiz: [
    ...
    },
    {
      ...
      grammar: {
        ...
        examples: [
          { en: "She said that technology had changed the way we communicate.", th: "เธอบอกว่าเทคโนโลยีได้เปลี่ยนแปลงวิธีที่เราสื่อสารกัน", highlight: "had changed" },
          { en: "He told me that he would upgrade his phone soon.", th: "เขาบอกฉันว่าเขาจะอัปเกรดโทรศัพท์ในเร็วๆ นี้", highlight: "would upgrade" },
          { en: "They said they were worried about screen addiction.", th: "พวกเขาบอกว่าพวกเขากังวลเกี่ยวกับการเสพติดหน้าจอ", highlight: "were worried" },
          { en: "She mentioned that artificial intelligence was becoming more common in daily life.", th: "เธอพูดถึงว่าปัญญาประดิษฐ์กำลังกลายเป็นเรื่องธรรมดามากขึ้นในชีวิตประจำวัน", highlight: "was becoming more common" }
        ]
      },
      vocabulary: [
        { en: "innovation", th: "นวัตกรรม", example: "This company is known for its constant innovation.", exampleTh: "บริษัทนี้เป็นที่รู้จักในเรื่องนวัตกรรมที่มีอย่างต่อเนื่อง" },
        { en: "addiction", th: "การเสพติด", example: "Smartphone addiction is a growing concern among teenagers.", exampleTh: "การเสพติดสมาร์ทโฟนเป็นความกังวลที่เพิ่มขึ้นในกลุ่มวัยรุ่น" },
        { en: "artificial", th: "ประดิษฐ์ / เทียม", example: "Artificial intelligence is used in many modern apps.", exampleTh: "ปัญญาประดิษฐ์ถูกนำมาใช้ในแอปพลิเคชันสมัยใหม่หลายตัว" },
        { en: "convenience", th: "ความสะดวกสบาย", example: "Online shopping offers great convenience.", exampleTh: "การช้อปปิ้งออนไลน์มอบความสะดวกสบายอย่างมาก" },
        { en: "dependence", th: "การพึ่งพา", example: "Our dependence on technology has increased significantly.", exampleTh: "การพึ่งพาเทคโนโลยีของเราเพิ่มขึ้นอย่างมีนัยสำคัญ" },
        { en: "breakthrough", th: "ความก้าวหน้าครั้งสำคัญ", example: "Scientists announced a major breakthrough in battery technology.", exampleTh: "นักวิทยาศาสตร์ประกาศความก้าวหน้าครั้งสำคัญด้านเทคโนโลยีแบตเตอรี่" },
        { en: "obsolete", th: "ล้าสมัย", example: "Many old devices have become obsolete.", exampleTh: "อุปกรณ์เก่าหลายชิ้นกลายเป็นของล้าสมัยไปแล้ว" },
        { en: "algorithm", th: "อัลกอริทึม", example: "The app's algorithm recommends videos based on your interests.", exampleTh: "อัลกอริทึมของแอปแนะนำวิดีโอตามความสนใจของคุณ" },
        { en: "privacy", th: "ความเป็นส่วนตัว", example: "People are becoming more concerned about online privacy.", exampleTh: "ผู้คนเริ่มกังวลเกี่ยวกับความเป็นส่วนตัวออนไลน์มากขึ้น" },
        { en: "interact", th: "มีปฏิสัมพันธ์", example: "Children today interact with screens more than with people.", exampleTh: "เด็กๆ ในปัจจุบันมีปฏิสัมพันธ์กับหน้าจอมากกว่ากับผู้คน" }
      ],
      reading: {
      ...
      story: {
        ...
        sentences: [
          { en: "When Nut bought a new smart speaker, the salesperson told him that it would make his life much easier.", th: "ตอนที่นัทซื้อลำโพงอัจฉริยะเครื่องใหม่ พนักงานขายบอกเขาว่ามันจะทำให้ชีวิตของเขาสะดวกสบายขึ้นมาก" },
          { en: "At first, the device simply played music and answered basic questions.", th: "ตอนแรก อุปกรณ์นี้เพียงแค่เปิดเพลงและตอบคำถามพื้นฐานเท่านั้น" },
          { en: "One night, Nut complained to his roommate that he was too dependent on his phone.", th: "คืนหนึ่ง นัทบ่นกับเพื่อนร่วมห้องว่าเขาพึ่งพาโทรศัพท์มากเกินไป" },
          { en: "Surprisingly, the smart speaker responded and said that it had noticed the same thing.", th: "น่าแปลกใจที่ลำโพงอัจฉริยะตอบกลับมาและบอกว่ามันสังเกตเห็นสิ่งเดียวกัน" },
          { en: "It mentioned that its algorithm had tracked his screen time and that it was concerned about his sleep.", th: "มันพูดว่าอัลกอริทึมของมันได้ติดตามเวลาที่เขาใช้หน้าจอ และมันกังวลเกี่ยวกับการนอนหลับของเขา" },
          { en: "Nut laughed nervously and told his roommate that the speaker had never spoken like that before.", th: "นัทหัวเราะอย่างกระอักกระอ่วนและบอกเพื่อนร่วมห้องว่าลำโพงไม่เคยพูดแบบนั้นมาก่อน" },
          { en: "The next day, the speaker suggested that he should try reading a book instead of scrolling through social media.", th: "วันถัดมา ลำโพงแนะนำว่าเขาควรลองอ่านหนังสือแทนการไถหน้าจอโซเชียลมีเดีย" },
          { en: "His roommate joked that the innovation had become more of a life coach than a music player.", th: "เพื่อนร่วมห้องของเขาแซวว่านวัตกรรมชิ้นนี้กลายเป็นโค้ชชีวิตมากกว่าเครื่องเล่นเพลงไปแล้ว" },
          { en: "Nut admitted that, despite feeling a little embarrassed, the advice had actually helped him sleep better.", th: "นัทยอมรับว่าแม้จะรู้สึกอายอยู่บ้าง แต่คำแนะนำนั้นก็ช่วยให้เขานอนหลับดีขึ้นจริงๆ" },
          { en: "He told his friends that he was no longer sure whether he owned the smart speaker, or whether it owned him.", th: "เขาบอกเพื่อนๆ ว่าตอนนี้เขาไม่แน่ใจแล้วว่าเขาเป็นเจ้าของลำโพงอัจฉริยะ หรือมันต่างหากที่เป็นเจ้าของเขา" }
        ]
      },
      quiz: [
    ...
    },
    {
      ...
      grammar: {
        ...
        examples: [
          { en: "If governments had acted sooner, they would have reduced the damage from climate change.", th: "ถ้ารัฐบาลลงมือทำตั้งแต่เนิ่นๆ พวกเขาก็จะสามารถลดความเสียหายจากการเปลี่ยนแปลงสภาพภูมิอากาศได้", highlight: "would have reduced" },
          { en: "The forest fire must have been caused by extreme heat and drought.", th: "ไฟป่าครั้งนี้น่าจะเกิดจากความร้อนจัดและภัยแล้งอย่างแน่นอน", highlight: "must have been caused" },
          { en: "If we had recycled more, we could have reduced plastic waste significantly.", th: "ถ้าเรารีไซเคิลมากกว่านี้ เราก็จะสามารถลดขยะพลาสติกลงได้อย่างมาก", highlight: "could have reduced" },
          { en: "The unusual weather might have been a result of rising global temperatures.", th: "สภาพอากาศที่ผิดปกตินี้อาจเป็นผลมาจากอุณหภูมิโลกที่สูงขึ้น", highlight: "might have been" }
        ]
      },
      vocabulary: [
        { en: "sustainable", th: "ยั่งยืน", example: "We need to develop more sustainable sources of energy.", exampleTh: "เราจำเป็นต้องพัฒนาแหล่งพลังงานที่ยั่งยืนมากขึ้น" },
        { en: "pollution", th: "มลพิษ", example: "Air pollution is a serious problem in many big cities.", exampleTh: "มลพิษทางอากาศเป็นปัญหาร้ายแรงในหลายเมืองใหญ่" },
        { en: "emission", th: "การปล่อยมลพิษ / ก๊าซ", example: "The factory has reduced its carbon emissions significantly.", exampleTh: "โรงงานได้ลดการปล่อยก๊าซคาร์บอนลงอย่างมีนัยสำคัญ" },
        { en: "drought", th: "ภัยแล้ง", example: "The region suffered a severe drought last year.", exampleTh: "ภูมิภาคนี้ประสบภัยแล้งรุนแรงเมื่อปีที่แล้ว" },
        { en: "ecosystem", th: "ระบบนิเวศ", example: "Cutting down forests damages the entire ecosystem.", exampleTh: "การตัดไม้ทำลายป่าสร้างความเสียหายต่อระบบนิเวศทั้งหมด" },
        { en: "renewable", th: "หมุนเวียน / นำกลับมาใช้ใหม่ได้", example: "Solar power is a popular renewable energy source.", exampleTh: "พลังงานแสงอาทิตย์เป็นแหล่งพลังงานหมุนเวียนที่ได้รับความนิยม" },
        { en: "deforestation", th: "การตัดไม้ทำลายป่า", example: "Deforestation has destroyed many natural habitats.", exampleTh: "การตัดไม้ทำลายป่าได้ทำลายที่อยู่อาศัยตามธรรมชาติไปมากมาย" },
        { en: "catastrophe", th: "หายนะ / ภัยพิบัติร้ายแรง", example: "Scientists warned that inaction could lead to an environmental catastrophe.", exampleTh: "นักวิทยาศาสตร์เตือนว่าการไม่ลงมือทำอะไรเลยอาจนำไปสู่หายนะทางสิ่งแวดล้อม" },
        { en: "mitigate", th: "บรรเทา / ลดผลกระทบ", example: "New policies aim to mitigate the effects of climate change.", exampleTh: "นโยบายใหม่มีเป้าหมายเพื่อบรรเทาผลกระทบจากการเปลี่ยนแปลงสภาพภูมิอากาศ" },
        { en: "awareness", th: "ความตระหนักรู้", example: "The campaign helped raise public awareness about pollution.", exampleTh: "แคมเปญนี้ช่วยสร้างความตระหนักรู้ของสาธารณชนเกี่ยวกับมลพิษ" }
      ],
      reading: {
      ...
      story: {
        ...
        sentences: [
          { en: "In a village surrounded by empty fields, only one old tree remained standing.", th: "ในหมู่บ้านที่ล้อมรอบด้วยทุ่งนาว่างเปล่า มีต้นไม้เก่าแก่เพียงต้นเดียวที่ยังยืนต้นอยู่" },
          { en: "The villagers often said that if their grandparents had planted more trees, the land would still be green today.", th: "ชาวบ้านมักพูดกันว่าถ้าปู่ย่าตายายของพวกเขาปลูกต้นไม้ไว้มากกว่านี้ ผืนดินก็คงยังเขียวชอุ่มอยู่จนถึงทุกวันนี้" },
          { en: "A young girl named Fon used to sit under that tree every afternoon and wonder about its story.", th: "เด็กหญิงคนหนึ่งชื่อฝนเคยนั่งใต้ต้นไม้ต้นนั้นทุกบ่ายและสงสัยเกี่ยวกับเรื่องราวของมัน" },
          { en: "One day, an old farmer told her that the drought years ago must have been caused by years of deforestation.", th: "วันหนึ่ง ชาวนาสูงอายุคนหนึ่งบอกเธอว่าภัยแล้งเมื่อหลายปีก่อนน่าจะเกิดจากการตัดไม้ทำลายป่าติดต่อกันมาหลายปี" },
          { en: "He said that if the villagers had protected the forest sooner, they could have avoided losing their farmland.", th: "เขาบอกว่าถ้าชาวบ้านปกป้องป่าไว้ตั้งแต่เนิ่นๆ พวกเขาก็คงจะหลีกเลี่ยงการสูญเสียพื้นที่เกษตรกรรมไปได้" },
          { en: "Determined not to repeat the same mistake, Fon started planting one seed every week beside the old tree.", th: "ด้วยความตั้งใจที่จะไม่ทำผิดพลาดซ้ำรอยเดิม ฝนเริ่มปลูกเมล็ดพันธุ์หนึ่งเมล็ดทุกสัปดาห์ข้างต้นไม้เก่าต้นนั้น" },
          { en: "Some neighbors thought it must have been a waste of time in such dry soil.", th: "เพื่อนบ้านบางคนคิดว่ามันคงเป็นการเสียเวลาเปล่าบนดินที่แห้งแล้งเช่นนี้" },
          { en: "But slowly, small green shoots began to appear around the old tree each season.", th: "แต่ค่อยๆ มีหน่ออ่อนสีเขียวเล็กๆ เริ่มปรากฏขึ้นรอบต้นไม้เก่าในแต่ละฤดู" },
          { en: "Years later, the single tree had grown into a small forest that brought back birds and cooler air.", th: "หลายปีต่อมา ต้นไม้เพียงต้นเดียวได้เติบโตกลายเป็นป่าเล็กๆ ที่นำนกและอากาศที่เย็นสบายกลับคืนมา" },
          { en: "The villagers now say that if Fon hadn't planted those seeds, the last tree might have stood there all alone forever.", th: "ทุกวันนี้ชาวบ้านพูดกันว่าถ้าฝนไม่ได้ปลูกเมล็ดพันธุ์เหล่านั้น ต้นไม้ต้นสุดท้ายก็คงยืนต้นอยู่อย่างโดดเดี่ยวตลอดไป" }
        ]
      },
      quiz: [
    ...
    },
    {
      ...
      grammar: {
        ...
        examples: [
          { en: "Sales have declined this quarter. However, we expect improvement next month.", th: "ยอดขายลดลงในไตรมาสนี้ อย่างไรก็ตาม เราคาดว่าจะดีขึ้นในเดือนหน้า", highlight: "However" },
          { en: "The proposal was well-received; therefore, we will proceed with implementation.", th: "ข้อเสนอนี้ได้รับการตอบรับเป็นอย่างดี ดังนั้น เราจะดำเนินการตามแผนต่อไป", highlight: "therefore" },
          { en: "The new system saves time. Moreover, it reduces the risk of errors.", th: "ระบบใหม่นี้ช่วยประหยัดเวลา ยิ่งไปกว่านั้น ยังช่วยลดความเสี่ยงของข้อผิดพลาดอีกด้วย", highlight: "Moreover" },
          { en: "We regret to inform you that the meeting has been postponed.", th: "เราเสียใจที่ต้องแจ้งให้ทราบว่าการประชุมถูกเลื่อนออกไป", highlight: "We regret to inform you" }
        ]
      },
      vocabulary: [
        { en: "stakeholder", th: "ผู้มีส่วนได้ส่วนเสีย", example: "We need to consult all stakeholders before making a decision.", exampleTh: "เราต้องปรึกษาผู้มีส่วนได้ส่วนเสียทุกฝ่ายก่อนตัดสินใจ" },
        { en: "proposal", th: "ข้อเสนอ", example: "The manager submitted a proposal for the new project.", exampleTh: "ผู้จัดการได้ยื่นข้อเสนอสำหรับโครงการใหม่" },
        { en: "revenue", th: "รายได้", example: "The company's revenue increased by ten percent this year.", exampleTh: "รายได้ของบริษัทเพิ่มขึ้นสิบเปอร์เซ็นต์ในปีนี้" },
        { en: "negotiation", th: "การเจรจา", example: "The negotiation between the two companies lasted several hours.", exampleTh: "การเจรจาระหว่างสองบริษัทใช้เวลานานหลายชั่วโมง" },
        { en: "correspondence", th: "การติดต่อสื่อสารทางจดหมาย/อีเมล", example: "Please keep a record of all correspondence with the client.", exampleTh: "กรุณาเก็บบันทึกการติดต่อสื่อสารทั้งหมดกับลูกค้าไว้" },
        { en: "agenda", th: "วาระการประชุม", example: "The first item on the agenda is the budget review.", exampleTh: "วาระแรกในการประชุมคือการทบทวนงบประมาณ" },
        { en: "feedback", th: "ข้อเสนอแนะ / ความคิดเห็นตอบกลับ", example: "We would appreciate your feedback on this proposal.", exampleTh: "เรายินดีรับฟังข้อเสนอแนะของคุณเกี่ยวกับข้อเสนอนี้" },
        { en: "procurement", th: "การจัดซื้อจัดจ้าง", example: "The procurement department is responsible for ordering supplies.", exampleTh: "ฝ่ายจัดซื้อจัดจ้างมีหน้าที่รับผิดชอบในการสั่งซื้ออุปกรณ์" },
        { en: "delegate", th: "มอบหมายงาน", example: "A good manager knows how to delegate tasks effectively.", exampleTh: "ผู้จัดการที่ดีรู้วิธีมอบหมายงานอย่างมีประสิทธิภาพ" },
        { en: "prioritize", th: "จัดลำดับความสำคัญ", example: "We need to prioritize the most urgent tasks first.", exampleTh: "เราต้องจัดลำดับความสำคัญของงานที่เร่งด่วนที่สุดก่อน" }
      ],
      reading: {
      ...
      story: {
        ...
        sentences: [
          { en: "On her first week at the company, an intern named Ing was asked to send a short update to her supervisor.", th: "ในสัปดาห์แรกที่ทำงาน อิงซึ่งเป็นเด็กฝึกงานถูกขอให้ส่งอัปเดตสั้นๆ ให้กับหัวหน้างานของเธอ" },
          { en: "Nervous and in a hurry, she accidentally selected \"reply all\" instead of replying to just one person.", th: "ด้วยความประหม่าและรีบร้อน เธอเผลอกดปุ่ม \"ตอบกลับทั้งหมด\" แทนที่จะตอบกลับแค่คนเดียว" },
          { en: "Within minutes, her casual message had been sent to every employee in the company, including the CEO.", th: "ภายในไม่กี่นาที ข้อความแบบไม่เป็นทางการของเธอถูกส่งไปถึงพนักงานทุกคนในบริษัท รวมถึงซีอีโอด้วย" },
          { en: "Her heart sank as she realized the message contained no formal greeting and several spelling mistakes.", th: "ใจของเธอวูบลงเมื่อรู้ว่าข้อความนั้นไม่มีคำทักทายที่เป็นทางการและมีคำสะกดผิดหลายจุด" },
          { en: "Fortunately, her manager reassured her that mistakes like this happen to everyone at some point.", th: "โชคดีที่หัวหน้าของเธอปลอบใจว่าความผิดพลาดแบบนี้เกิดขึ้นกับทุกคนได้ในบางครั้ง" },
          { en: "Together, they drafted a follow-up email that began, \"We regret to inform you that the previous message was sent by mistake.\"", th: "พวกเขาช่วยกันร่างอีเมลติดตามผลที่ขึ้นต้นว่า \"เราเสียใจที่ต้องแจ้งให้ทราบว่าข้อความก่อนหน้านี้ถูกส่งไปโดยความผิดพลาด\"" },
          { en: "The message used a formal register and included a sincere apology to all the stakeholders involved.", th: "ข้อความนั้นใช้ภาษาทางการและมีคำขอโทษอย่างจริงใจถึงผู้มีส่วนได้ส่วนเสียทุกฝ่ายที่เกี่ยวข้อง" },
          { en: "Surprisingly, several colleagues replied with kind words; moreover, one director praised her honesty.", th: "น่าประหลาดใจที่เพื่อนร่วมงานหลายคนตอบกลับมาด้วยถ้อยคำใจดี ยิ่งไปกว่านั้น ผู้อำนวยการคนหนึ่งยังชื่นชมความซื่อสัตย์ของเธออีกด้วย" },
          { en: "From then on, Ing always double-checked the recipient list before clicking send.", th: "ตั้งแต่นั้นเป็นต้นมา อิงจะตรวจสอบรายชื่อผู้รับซ้ำเสมอก่อนกดส่งอีเมล" },
          { en: "She later joked that her most embarrassing moment had, in the end, become her most valuable lesson in professional communication.", th: "ภายหลังเธอพูดติดตลกว่าช่วงเวลาที่น่าอายที่สุดของเธอ ในที่สุดก็กลายเป็นบทเรียนที่มีค่าที่สุดเรื่องการสื่อสารอย่างมืออาชีพ" }
        ]
      },
      quiz: [
    ...
    },
    {
      ...
      grammar: {
        ...
        examples: [
          { en: "Furthermore, studies have shown that remote work increases productivity.", th: "ยิ่งไปกว่านั้น งานวิจัยหลายชิ้นแสดงให้เห็นว่าการทำงานทางไกลช่วยเพิ่มประสิทธิภาพการทำงาน", highlight: "Furthermore" },
          { en: "Nevertheless, some employees still prefer working in an office.", th: "อย่างไรก็ตาม พนักงานบางคนก็ยังคงชอบทำงานที่ออฟฟิศมากกว่า", highlight: "Nevertheless" },
          { en: "In contrast, younger workers tend to value flexibility more than job security.", th: "ในทางตรงกันข้าม พนักงานรุ่นใหม่มักให้ความสำคัญกับความยืดหยุ่นมากกว่าความมั่นคงในงาน", highlight: "In contrast" },
          { en: "As a result, many companies have adopted hybrid working models.", th: "เป็นผลให้บริษัทหลายแห่งได้นำรูปแบบการทำงานแบบผสมผสานมาใช้", highlight: "As a result" }
        ]
      },
      vocabulary: [
        { en: "persuasive", th: "โน้มน้าวใจ", example: "She gave a persuasive speech that convinced the audience.", exampleTh: "เธอกล่าวสุนทรพจน์ที่โน้มน้าวใจจนสามารถทำให้ผู้ฟังเชื่อได้" },
        { en: "rebuttal", th: "การโต้แย้งกลับ", example: "His rebuttal weakened the opposing team's argument.", exampleTh: "การโต้แย้งกลับของเขาทำให้ข้อโต้แย้งของทีมฝ่ายตรงข้ามอ่อนลง" },
        { en: "evidence", th: "หลักฐาน", example: "You need strong evidence to support your argument.", exampleTh: "คุณต้องมีหลักฐานที่หนักแน่นเพื่อสนับสนุนข้อโต้แย้งของคุณ" },
        { en: "articulate", th: "พูดได้ชัดเจน / แสดงความคิดได้ดี", example: "She is very articulate when explaining complex ideas.", exampleTh: "เธอพูดได้อย่างชัดเจนมากเวลาอธิบายแนวคิดที่ซับซ้อน" },
        { en: "coherent", th: "มีเหตุผลสอดคล้องกัน / เป็นระเบียบ", example: "His presentation was clear and coherent from start to finish.", exampleTh: "การนำเสนอของเขาชัดเจนและมีเหตุผลสอดคล้องกันตั้งแต่ต้นจนจบ" },
        { en: "emphasize", th: "เน้นย้ำ", example: "The speaker emphasized the importance of teamwork.", exampleTh: "ผู้พูดเน้นย้ำถึงความสำคัญของการทำงานเป็นทีม" },
        { en: "summarize", th: "สรุป", example: "Let me summarize the main points before we finish.", exampleTh: "ขอสรุปประเด็นหลักก่อนที่เราจะจบกัน" },
        { en: "audience", th: "ผู้ฟัง / ผู้ชม", example: "The audience asked several challenging questions after the presentation.", exampleTh: "ผู้ฟังถามคำถามที่ท้าทายหลายข้อหลังจบการนำเสนอ" },
        { en: "rhetoric", th: "วาทศิลป์ / การใช้ภาษาโน้มน้าว", example: "Politicians often use powerful rhetoric to win support.", exampleTh: "นักการเมืองมักใช้วาทศิลป์ที่ทรงพลังเพื่อให้ได้รับการสนับสนุน" },
        { en: "concede", th: "ยอมรับข้อโต้แย้ง / ยอมแพ้", example: "After hearing the evidence, she conceded that her opponent had a valid point.", exampleTh: "หลังจากได้ฟังหลักฐานแล้ว เธอยอมรับว่าคู่โต้แย้งของเธอมีประเด็นที่สมเหตุสมผล" }
      ],
      reading: {
      ...
      story: {
        ...
        sentences: [
          { en: "Kwan had always been terrified of public speaking, even though she was full of good ideas.", th: "ขวัญกลัวการพูดในที่สาธารณะมาโดยตลอด ทั้งที่เธอเต็มไปด้วยไอเดียดีๆ มากมาย" },
          { en: "When her teacher asked her to represent the class in the school debate, she almost refused.", th: "เมื่อครูของเธอขอให้เธอเป็นตัวแทนของชั้นเรียนในการแข่งขันโต้วาทีของโรงเรียน เธอเกือบจะปฏิเสธ" },
          { en: "Her best friend told her, \"Furthermore, you're the only one who has actually read all the research.\"", th: "เพื่อนสนิทของเธอบอกว่า \"ยิ่งไปกว่านั้น เธอเป็นคนเดียวที่อ่านงานวิจัยทั้งหมดจริงๆ\"" },
          { en: "Nervous but determined, Kwan spent the whole week practicing how to structure a coherent argument.", th: "แม้จะประหม่าแต่ก็มุ่งมั่น ขวัญใช้เวลาทั้งสัปดาห์ฝึกฝนวิธีจัดลำดับข้อโต้แย้งให้มีเหตุผลสอดคล้องกัน" },
          { en: "On the day of the debate, her hands were shaking, but she reminded herself to speak slowly and clearly.", th: "ในวันแข่งโต้วาที มือของเธอสั่น แต่เธอเตือนตัวเองให้พูดช้าๆ และชัดเจน" },
          { en: "Her opponent presented a strong case; nevertheless, Kwan remained calm and offered a thoughtful rebuttal.", th: "คู่แข่งของเธอนำเสนอข้อโต้แย้งที่หนักแน่น กระนั้นก็ตาม ขวัญยังคงสงบและเสนอข้อโต้แย้งกลับอย่างรอบคอบ" },
          { en: "In contrast to her usual quiet self, she spoke with confidence and used evidence to support every point.", th: "ตรงกันข้ามกับตัวเองที่เงียบขรึมตามปกติ เธอพูดด้วยความมั่นใจและใช้หลักฐานสนับสนุนทุกประเด็น" },
          { en: "As a result, the judges praised her for being articulate, persuasive, and remarkably composed.", th: "เป็นผลให้กรรมการชื่นชมเธอที่พูดได้ชัดเจน โน้มน้าวใจ และควบคุมสติได้อย่างน่าทึ่ง" },
          { en: "When she won first place, Kwan could hardly believe that the girl who once feared microphones was now holding a trophy.", th: "เมื่อเธอได้รับรางวัลชนะเลิศ ขวัญแทบไม่อยากเชื่อว่าเด็กสาวที่เคยกลัวไมโครโฟนกลายเป็นคนที่ถือถ้วยรางวัลอยู่ในมือ" },
          { en: "She later told her classmates that the hardest part had never been the topic, but simply believing in her own voice.", th: "ภายหลังเธอบอกเพื่อนร่วมชั้นว่าส่วนที่ยากที่สุดไม่เคยเป็นหัวข้อโต้วาทีเลย แต่เป็นการเชื่อมั่นในเสียงของตัวเองต่างหาก" }
        ]
      },
      quiz: [
